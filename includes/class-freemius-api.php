...
final class Api {
	...
	/**
	 * @param Wbcr_Factory000_Plugin $slug
	 ...
	 */
	private function __construct( Wbcr_Factory000_Plugin $plugin, $scope, $id, $public_key, $secret_key, $is_sandbox ) {
	 ...
	 * @return Api
	 */
	public static function instance( Wbcr_Factory000_Plugin $plugin, $scope, $id, $public_key, $is_sandbox, $secret_key = false ) {
